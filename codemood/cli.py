...
def update_package() -> None:
    ...
    try:
        ...
        subprocess.check_call([sys.executable, "-m", "pip", "install", "--upgrade", "codemood"])
...
def main() -> None:
    ...
    parser.add_argument("-u", "--update", action="store_true", help="Update to latest version")
    parser.add_argument("-i", "--info", action="store_true", help="Show package information")
