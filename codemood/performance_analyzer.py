            ...
            if re.search(r'\b(for|while)\b', line):
                ...
                if loop_depth > 1:
                    issues.append(PerformanceIssue(
                        ...
                        line=line_num,
                        impact='high',
                        description=self.anti_patterns['nested_loops']['description'],
        ...
        for line_num, line in enumerate(lines, 1):
            if re.search(r'\b(for|while)\b', line):
                ...
                issues.append(PerformanceIssue(
                    ...
                    line=line_num,
                    impact='medium',
                    description=self.anti_patterns['string_concatenation']['description'],
                    suggestion=self.anti_patterns['string_concatenation']['suggestion']
                ))
        ...
        for line_num, line in enumerate(lines, 1):
            if re.search(r'\bglobal\s+\w+', line):
                issues.append(PerformanceIssue(
                    ...
                    line=line_num,
                    impact='low',
                    description=self.anti_patterns['global_variables']['description'],
